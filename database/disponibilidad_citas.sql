...
CREATE TABLE IF NOT EXISTS disponibilidad_citas (
    ...
    CONSTRAINT fk_admin_disponibilidad FOREIGN KEY (admin_id)
...
COMMENT ON TABLE disponibilidad_citas IS 'Slots de tiempo disponibles para agendar citas';
COMMENT ON COLUMN disponibilidad_citas.estado IS 'disponible, ocupada o cancelada';
